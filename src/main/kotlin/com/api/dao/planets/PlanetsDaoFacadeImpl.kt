...
fun insertPlanets(){
    val planets = listOf(
        ...
        PlanetContent("Glavis Ringworld", "Glavis Ringworld is a space station that encircled a small star. Day and night cycles artificially occur due to the sunlight that passed through the open loop. The Mandalorian visited Glavis Ringworld to find the hidden Mandalorian covert.", "https://static.wikia.nocookie.net/starwars/images/1/16/Glavis_BoBF.png/revision/latest?cb=20220130053325"),
